...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        searchButton.setOnClickListener {
            ...
            val city = findViewById<TextView>(R.id.city_editTextText).text.toString()
            hideKeyboard()
                ...
                .enqueue(object : Callback<EventsList> {
                    override fun onResponse(
                        ...
                        if (body == null || body._embedded == null) {
                            ...
                            findViewById<RecyclerView>(R.id.recylerView).visibility = RecyclerView.INVISIBLE
                        ...
                        findViewById<RecyclerView>(R.id.recylerView).visibility = RecyclerView.VISIBLE
