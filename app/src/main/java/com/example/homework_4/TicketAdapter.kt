...
class TicketAdapter(private val users: ArrayList<User>) : RecyclerView.Adapter<TicketAdapter.MyViewHolder>() {
    ...
    inner class MyViewHolder (itemView: View): RecyclerView.ViewHolder (itemView) {
        ...
        val gender = itemView.findViewById<TextView>(R.id.event_date)
        val email = itemView.findViewById<TextView>(R.id.event_location)
        val profileImage = itemView.findViewById<ImageView>(R.id.event_image)
